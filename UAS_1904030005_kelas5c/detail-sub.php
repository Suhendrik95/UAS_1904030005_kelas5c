...
<body id="page-top">
  ...
  <div class="col-md-10 p-5 pt-5 mt-5 pb-5">
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item">Nama Pelajaran<?= $mk['nama_pelajaran']; ?></li>
      <li class="list-group-item">Kelas 1<?= $mk['kelas1']; ?></li>
      <li class="list-group-item">Kelas 2<?= $mk['kelas2']; ?></li>
      <li class="list-group-item">Kelas 3<?= $mk['kelas3']; ?></li>
      <li class="list-group-item">
        <a href="edit.php?id=<?= $mk['id']; ?>" class="btn btn-warning" role="button">Edit</a>
        ...
        <a href="detail.php" class="btn btn-primary" role="button">Kembali</a>
      </li>
    </ul>
